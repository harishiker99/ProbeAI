...
class SentenceTransformerEmbedderr(Embeddings):
    # def __init__(self, model_name="all-roberta-large-v1"):
    def __init__(self, model_name="stsb-roberta-large"):
        """
        Initialize the SentenceTransformerEmbedder with a specific model.

        Args:
            model_name (str): The name of the model to use for embedding.
        """
        self.embedder = SentenceTransformerEmbedder(id=model_name, dimensions=1024)
...
# Constants
COLLECTION_NAME = "1024-stsb-roberta-large-deepseek-r1-1.5B"


# Streamlit App Initialization
st.title("🐋 Probe AI Reasoning Agent")
...
def create_vector_store(client, texts):
    ...
    try:
        ...
        vector_store = QdrantVectorStore(
            client=client,
            collection_name=COLLECTION_NAME,
            embedding=SentenceTransformerEmbedderr()
        )
...
Please provide a comprehensive answer based on the available information."""
    ...
    st.warning("DeepSeek-R1 reasoning locally, toggle the RAG mode to upload documents!")